...
@Getter
@NoArgsConstructor
public class DemoOutboxEventEntity {
  ...
  static DemoOutboxEventEntity fromDomain(OutboxEvent outboxEvent) {
    return new DemoOutboxEventEntity(
        outboxEvent.getId(),
