...
public class AuditController {
  ...
  private final GetOutboxEventsUseCase getOutboxEventsUseCase;

  public AuditController(
      VerifyAuditChainUseCase verifyAuditChainUseCase,
      GetOutboxEventsUseCase getOutboxEventsUseCase) {
    this.verifyAuditChainUseCase = verifyAuditChainUseCase;
    this.getOutboxEventsUseCase = getOutboxEventsUseCase;
  }
  ...
  public ResponseEntity<PageResponse<OutboxEventResponse>> getEvents(
    ...
    PagedResult<OutboxEvent> result =
        getOutboxEventsUseCase.getEvents(new GetOutboxEventsQuery(page, size));
