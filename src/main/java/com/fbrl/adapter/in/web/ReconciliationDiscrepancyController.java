...
public class ReconciliationDiscrepancyController {

  private final SearchReconciliationDiscrepanciesUseCase searchReconciliationDiscrepanciesUseCase;

  public ReconciliationDiscrepancyController(
      SearchReconciliationDiscrepanciesUseCase searchReconciliationDiscrepanciesUseCase) {
    this.searchReconciliationDiscrepanciesUseCase = searchReconciliationDiscrepanciesUseCase;
  }
  ...
  public ResponseEntity<PageResponse<ReconciliationDiscrepancyResponse>> search(
    ...
    PagedResult<ReconciliationDiscrepancy> result =
        searchReconciliationDiscrepanciesUseCase.search(
