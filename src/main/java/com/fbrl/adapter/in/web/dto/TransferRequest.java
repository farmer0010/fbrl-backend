...
public record TransferRequest(
    @NotBlank(message = "출금 계좌 번호는 필수입니다.") String senderAccountNumber,
    @NotBlank(message = "입금 계좌 번호는 필수입니다.") String receiverAccountNumber,
    @NotNull(message = "송금 금액은 필수입니다.")
        @Positive(message = "송금 금액은 양수여야 합니다.")
        @Digits(integer = 19, fraction = 0, message = "소수점 금액은 입력할 수 없습니다.")
        BigDecimal amount) {
