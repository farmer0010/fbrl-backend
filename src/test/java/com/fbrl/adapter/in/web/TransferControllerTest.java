...
@DisplayName("TransferController 단위 테스트")
class TransferControllerTest {
  ...
  void setUp() {
    ...
    mockMvc =
        MockMvcBuilders.standaloneSetup(new TransferController(transferMoneyUseCase))
  ...
  void transferValidationFailureWhenSenderBlank() throws Exception {
    TransferRequest request = new TransferRequest("", "222-222", BigDecimal.valueOf(10000));
    ...
    mockMvc
        ...
        .andExpect(jsonPath("$.message").value("출금 계좌 번호는 필수입니다."));
  }
  ...
  void transferAccountNotFound() throws Exception {
    TransferRequest request = new TransferRequest("111-111", "999-999", BigDecimal.valueOf(10000));
  ...
  void transferInsufficientBalance() throws Exception {
    TransferRequest request =
        new TransferRequest("111-111", "222-222", BigDecimal.valueOf(1000000));
